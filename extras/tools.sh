...
compile_tools()
{
	...
	pack_to_deb()
	{
		...
		install -m 644 $SRC/scripts/brcm40183					$tmpdir/armbian-tools-${RELEASE}_${REVISION}_${ARCH}/etc/default
		install -m 755	$SRC/scripts/brcm40183-patch			$tmpdir/armbian-tools-${RELEASE}_${REVISION}_${ARCH}/etc/init.d
		
		# ap6212 configs and service
		install -m 644 $SRC/scripts/ap6212						$tmpdir/armbian-tools-${RELEASE}_${REVISION}_${ARCH}/etc/default
		install -m 755 $SRC/scripts/ap6212-bluetooth			$tmpdir/armbian-tools-${RELEASE}_${REVISION}_${ARCH}/etc/init.d
